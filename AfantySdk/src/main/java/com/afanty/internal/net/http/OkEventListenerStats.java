...
public class OkEventListenerStats extends EventListener {
    ...
    public void responseHeadersEnd(Call call, Response response) {
        ...
        HttpAnalyzerHelper.obtain(call).traceRecvHeaderEnd(response.code(), size, cacheHit == null ? null : cacheHit.toString());
    ...
    private static class HttpAnalyzerHelper {
        ...
        private static HttpAnalyzer sEmptyAnalyzer = new HttpAnalyzer("null", "null", "null", "null", "null");
        ...
        static HttpAnalyzer obtain(Call call, boolean needCreate) {
            try {
                ...
                HttpAnalyzer analyzer = new HttpAnalyzer(traceId, call.request().url().toString(), call.request().header("business"), call.request().header("load_type"), call.request().method());
